...
//        return originalToGeneratedInterface?.generated?.typeSpec?.containsPropertySignature() == true
    ...
    /**
     * 1. Replace original superinterfaces if they're standalone interfaces generated by @ToNativeInterface
     * 2. Add the missing superinterface autogenerated from current class with @ToNativeInterface
     */
    private val superInterfaces: MutableList<TypeName> = originalTypeSpec.superinterfaces.keys
//        .toMutableList()
//        .apply {
//            generatedInterfaces.values.forEach {
//
//            }
//        }
        .mapNotNull { interfaceName ->
            when (val matchingSuper = generatedInterfaces.values.find { it.name == interfaceName }) {
                null -> null
...
//            }
        ...
        .apply {
            ...
            println("AAAAAAB: $missingSuperInterface")
